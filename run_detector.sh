...
python yolo_det.py -l weights/obj.names -cfg weights/yolov3_ball.cfg -w weights/yolov3_2000_round2.weights -v video7.mp4 -s -out_txt det_tracking/det_yolo_video7.txt
